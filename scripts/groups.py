...
from scripts.support import import_image 
...
class AllSprites(pygame.sprite.Group):
  def __init__(self):
    ...
    self.shadow_surface = import_image('assets', 'graphics', 'other', 'shadow')
    self.notice_surf = import_image('assets', 'graphics', 'ui', 'notice') 
